...
import com.devstroop.fsstp.preference.accessor.getSetPrefValue
...
import com.devstroop.fsstp.preference.accessor.setSetPrefValue
import com.devstroop.fsstp.preference.accessor.setStringPrefValue
import com.devstroop.fsstp.preference.accessor.setURIPrefValue
import com.devstroop.fsstp.preference.custom.DirectoryPreference
import com.devstroop.fsstp.service.ACTION_VPN_CONNECT
import com.devstroop.fsstp.service.ACTION_VPN_DISCONNECT
import com.devstroop.fsstp.service.SstpVpnService
...
class SstpFlutterPlugin: FlutterPlugin, MethodCallHandler , ActivityAware, FlutterFragmentActivity() {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "fsstp")
